    ...
    <div className="bg-white border border-gray-100 rounded-2xl w-full max-w-sm p-6 shadow-2xl">
      ...
      <div className="flex gap-3 justify-end">
        ...
        <button onClick={onConfirm}
          className={`px-5 py-2 text-sm font-semibold rounded-xl transition ${danger
...
export const Toasts = ({ toasts }) => (
  <div className="fixed bottom-6 right-6 z-[200] flex flex-col gap-2 pointer-events-none">
    {toasts.map(t => (
      <div key={t.id}
        className={`flex items-center gap-2.5 px-4 py-3 rounded-xl text-sm font-medium shadow-2xl animate-[slideUp_0.25s_ease] pointer-events-auto ${t.type === "success" ? "bg-emerald-500 text-white" :
